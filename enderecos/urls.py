...
urlpatterns = [
    ...
    path('municipios/<int:municipio_id>/', visualizar_municipio, name='visualizar_municipio'),
    ...
    path('comarcas/<int:comarca_id>/', visualizar_comarca, name='visualizar_comarca'),
    ...
    path('logradouros/<int:logradouro_id>/', visualizar_logradouro, name='visualizar_logradouro'),
